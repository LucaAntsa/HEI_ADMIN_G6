...
export default defineConfig({
  ...
  env: {
    ...
    INSTATUS_AUTH_COMPONENT_ID: process.env.INSTATUS_AUTH_COMPONENT_ID,
    INSTATUS_PAYMENT_COMPONENT_ID: process.env.INSTATUS_PAYMENT_COMPONENT_ID,
    INSTATUS_PRESENCE_COMPONENT_ID: process.env.INSTATUS_PRESENCE_COMPONENT_ID,
    INSTATUS_ETUDIANT_COMPONENT_ID: process.env.INSTATUS_ETUDIANT_COMPONENT_ID,
